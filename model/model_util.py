...
def get_optimizer(config, params):
    ...
    #     #     {'params': [p for n, p in params.bert.named_parameters() if not any(nd in n for nd in no_decay)], 'weight_decay': 0.01},
    #     #     {'params': [p for n, p in params.bert.named_parameters() if any(nd in n for nd in no_decay)], 'weight_decay': 0.0},
    #     #     {"params": params.linear.parameters(), 'lr':config.bert.linear_lr}
    #     # ]
    #     # return AdamW(optimizer_grouped_parameters, 
    #     #              lr=config.bert.bert_lr, 
    #     #              eps=config.bert.eps)
                     
    #     return AdamW(
    #         [
    #             {"params": params.bert.parameters(), 'lr':config.bert.bert_lr, 'weight_decay':0.0001},
    #             {"params": params.linear.parameters(), 'lr':config.bert.linear_lr}
    #         ], 
    #         lr=config.bert.bert_lr, 
    #         eps=config.bert.eps
